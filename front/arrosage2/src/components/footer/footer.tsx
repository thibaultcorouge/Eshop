        ...
        <footer className="bg-white dark:bg-gray-900">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="/" className="flex items-center">
                            <img src={logo} className="h-13 my-5" alt="arrosage 2.0" />
                        </a>
                    </div>
                    <div className="flex flex-row flex-wrap gap-8 mb-6 ">
                    {/* <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3"></div> */}
                        <div className="mr-2">
                            <h2 className="mb-2 text-sm font-semibold text-gray-900 uppercase dark:text-white">Adresse</h2>
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li className="mb-1">
                                    Lieu dit San Lorenzo, Biguglia <br/>
                                    20620
                                </li>
                                <li className="mb-1">
                                    Tel: <a href="tel:+33615791199" className="hover:underline">+33 (0)6 15 79 11 99</a>
                                </li>
                            </ul>
                        </div>
                        <div className="mr-2">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://arrosage2point0.fr" className="hover:underline">Arrosage2.0™</a>. All Rights Reserved.
                    </span>
